    ...
    <div>
      ...
      <div>
        <div className="p-4">
          ...
          <h1 className="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Hiking in Kejimkujik National Park and National Historic Site</h1>
          ...
          <p className="text-sm text-slate-500">Looking to take your team away on a retreat to enjoy awesome food and take in some sunshine?
